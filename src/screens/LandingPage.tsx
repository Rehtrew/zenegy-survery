...
export function LandingPage({ onStart }: Props) {
  return (
    <div style={{
      ...
      {/* Header */}
      <header style={{ width: '100%', maxWidth: 700, display: 'flex', alignItems: 'center', marginBottom: 40 }}>
        <ZenegyLogoFull color="var(--color-text-primary)" />
      </header>
